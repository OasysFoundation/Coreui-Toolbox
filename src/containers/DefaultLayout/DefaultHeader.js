...
import logo from '../../assets/img/brand/oasys_logo_big.png'
import logoSmall from '../../assets/img/brand/oasys_logo_small.png'

/*
Customization so far:
Logo: https://www.canstockphoto.de/polygonal-origami-eule-45479856.html
  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        <AppNavbarBrand
          full={{ src: logo, height: 35, alt: 'Oasys Logo' }}
          minimized={{ src: logoSmall, width: 32, height: 35, alt: 'Oasys Logo' }}
        />
